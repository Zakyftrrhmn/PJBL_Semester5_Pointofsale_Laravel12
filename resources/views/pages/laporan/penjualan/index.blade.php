...
@section('subtitle', 'Daftar transaksi penjualan')
@section('content')
    ...
    <div class="space-y-6">
        ...
        {{-- WIDGET RINGKASAN DATA (Diperbaiki agar konsisten dengan referensi) --}}
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="p-5 bg-white rounded-xl shadow-lg border-l-4 border-green-500">
                {{-- Diubah dari 'Total Nilai Penjualan' menjadi 'Total Transaksi' agar konsisten --}}
                <p class="text-xs font-medium text-gray-500 uppercase">Total Transaksi</p>
                <p class="mt-1 text-base font-semibold text-gray-900">
                    {{ $penjualans->total() }} Transaksi
                </p>
            </div>
            <div class="p-5 bg-white rounded-xl shadow-lg border-l-4 border-indigo-500">
                {{-- Diubah dari 'Status Filter' menjadi 'Total Bayar (Filtered)' agar konsisten --}}
        ...
        {{-- FORM FILTER DENGAN PRESET DAN STATUS (MENGGUNAKAN ALPINE JS DARI REFERENSI) --}}
            ...
            <div class="flex space-x-2 flex-shrink-0">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative group">
                        <a href="{{ route('laporan.penjualan.export.pdf', $exportParams) }}" target="_blank"
                        ...
                        @forelse ($penjualans as $index => $penjualan)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                    {{ \Carbon\Carbon::parse($penjualan->tanggal_penjualan)->format('d F Y') }}
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-8 text-center text-gray-400 text-lg bg-gray-50">
                                    <i class='bx bx-info-circle mr-1'></i> Tidak ada data penjualan yang ditemukan sesuai
                                    filter.
                                </td>
                            </tr>
                        @endforelse
    ...
    {{-- Script JavaScript lama sudah dihapus karena logic ditangani Alpine JS --}}
@endsection
