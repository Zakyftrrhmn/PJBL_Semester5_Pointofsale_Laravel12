...
@section('title', 'Tambah Merek Produk')
@section('subtitle', 'Isi formulir untuk menambahkan merek produk baru')
@section('content')
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="p-5 sm:p-6">
                <form action="{{ route('merek.store') }}" method="POST" class="space-y-5">
                    @csrf
