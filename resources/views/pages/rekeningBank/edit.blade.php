...
@section('subtitle', 'Perbarui detail rekening bank di bawah ini.')
@section('content')
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="p-5 sm:p-6">
                <form action="{{ route('rekeningBank.update', $rekeningBank->id) }}" method="POST" class="space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_bank" name="nama_bank" value="{{ $rekeningBank->nama_bank }}"
                    ...
                    <div>
                        ...
                        <input type="number" id="no_rekening" name="no_rekening" value="{{ $rekeningBank->no_rekening }}"
                            class="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm focus:border-blue-400 focus:ring focus:ring-blue-100 sm:text-sm p-2.5"
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_pemilik_rekening" name="nama_pemilik_rekening"
                            value="{{ $rekeningBank->nama_pemilik_rekening }}"
                            class="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm focus:border-blue-400 focus:ring focus:ring-blue-100 sm:text-sm p-2.5"
