...
@section('subtitle', 'Isi formulir untuk menambahkan pemasok baru')
@section('content')

    <div class="space-y-6">
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
            <div class="p-5 sm:p-6">
                <form action="{{ route('pemasok.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                    @csrf

                    <div>
                        <label for="nama_pemasok" class="block text-sm font-medium text-gray-700">Nama Pemasok <span
                                class="text-red-500">*</span></label>
                        <input type="text" id="nama_pemasok" name="nama_pemasok" value="{{ old('nama_pemasok') }}"
